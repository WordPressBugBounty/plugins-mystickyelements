...
class Sticky_elements_review_box
{
	...
	public function admin_notices()
	{
        ...
        <div class="notice notice-info premio-notice <?php echo esc_attr($this->pluginSlug) ?>-premio-review-box">
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default">
                <h2 class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default__title">
					<?php esc_html_e('Your', 'mystickyelements') ?> <span><?php esc_html_e('feedback', 'mystickyelements') ?></span> <?php esc_html_e('matters, please leave a review', 'mystickyelements') ?> 🙏
                </h2>
                ...
                <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default__co-founder">
                    <span>
                        <b><?php esc_html_e('Gal Dubinski', 'mystickyelements') ?></b>,
                        <?php esc_html_e('Co-founder', 'mystickyelements') ?>
                    </span>
                    <img class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default__co-founder-img" width="30" height="30" src="<?php echo esc_url(MYSTICKYELEMENTS_URL."images/premio-owner.png") ?>" />
                </div>

                <div class="please-rate-us">
                    <div class="rate-us-title"><?php esc_html_e("Please rate us:", 'mystickyelements'); ?></div>
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__thank-you">
                <div class="thanks-wrap">
                    ...
                    <img class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__thank-you__image" width="200" src="<?php echo esc_url(MYSTICKYELEMENTS_URL."images/thanks.gif") ?>" />

                    <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__thank-you__message">
                        <div class="title"><?php esc_html_e("You are awesome ", 'mystickyelements')?> &#128591;</div>
                        <div class="desc"><?php esc_html_e("Thanks for your support, we really appreciate it!", 'mystickyelements')?></div>
                        <div class="footer"><?php esc_html_e("Premio team ", 'mystickyelements')?></div>
                    </div>
                </div>
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-review-box-popup">
                <div class="<?php echo esc_attr($this->pluginSlug) ?>-review-box-popup__content">
                    ...
                    <div class="<?php echo esc_attr($this->pluginSlug) ?>-review-box-popup__title">
						<?php esc_html_e("Would you like us to remind you about this later?", 'mystickyelements')?>
                    </div>

                    <div class="<?php echo esc_attr($this->pluginSlug) ?>-review-box-popup__options">
                        <a href="#" data-days="3"><?php esc_html_e("Remind me in 3 days ", 'mystickyelements')?></a>
                        <a href="#" data-days="10"><?php esc_html_e("Remind me in 10 days ", 'mystickyelements')?></a>
                        <a href="#" data-days="-1" class="dismiss"><?php esc_html_e("Don't remind me about this ", 'mystickyelements')?></a>
                    </div>
                </div>
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-feedback-popup">
                <div class="<?php echo esc_attr($this->pluginSlug) ?>-feedback-popup__content">
                    ...
                    <form class="<?php echo esc_attr($this->pluginSlug) ?>-feedback-popup__form">
                        ...
                        <button id="submit-btn" type="submit"><?php esc_html_e('Submit', 'mystickyelements') ?></button>
                    </form>
                </div>
        ...
        <script>
            (function($) {
                function StickyElementsFreeReview() {
                ...
                StickyElementsFreeReview.prototype.getSelectors = function() {
                    return {
                        body: 'body',
                ...
                StickyElementsFreeReview.prototype.getElements = function() {
                ...
                StickyElementsFreeReview.prototype.bindEvents = function() {
                ...
                StickyElementsFreeReview.prototype.feedbackFormHandler = function(ev) {
                    ev.preventDefault();
                    const elements  = this.getElements();
                ...
                StickyElementsFreeReview.prototype.thankYouDismissHandler = function() {
                    const elements = this.getElements();
                    elements.$reviewBox.remove();
                    elements.$reminderPopup.remove();
                    this.sendHideRequest( -1 );
                ...
                StickyElementsFreeReview.prototype.reminderHandler = function(ev) {
                    ev.preventDefault();
                ...
                StickyElementsFreeReview.prototype.sendHideRequest = function( dataDays = -1 ) {
                    $.ajax({
                        url: "<?php echo admin_url("admin-ajax.php") ?>",
                ...
                StickyElementsFreeReview.prototype.toggleReminderPopup = function( action = true ) {
                    if( action ) {
                ...
                StickyElementsFreeReview.prototype.feedbackToggle = function( action = true ) {
                    const elements = this.getElements();
                    console.log(action);
                    if( action ) {
                ...
                StickyElementsFreeReview.prototype.renderRating = function() {
                    const self      = this;
...
$Sticky_elements_review_box = new Sticky_elements_review_box();
