<?php
class MyStickyElements_affiliate_program {

    public $plugin = "mystickyelement";

    public function __construct() {
        add_action("wp_ajax_".$this->plugin."_affiliate_program", array($this, "mystickyelement_affiliate_program"));

        add_action('admin_notices', array($this, 'mystickyelement_admin_notices'));
    }

    public function mystickyelement_affiliate_program() {
    ...
    public function mystickyelement_admin_notices() {
        ...
        <div class="notice notice-info premio-affiliate <?php echo esc_attr($this->plugin) ?>-premio-affiliate">
            <p>Hi there, you've been using My Sticky Elements for a while now. Do you know that <b>My Sticky Elements</b> has an affiliate program? Join now and get <b>25% lifetime commission</b> <a href="#" class="dismiss-btn"><span class="dashicons dashicons-no-alt"></span> Dismiss</a></p>
            <div class="clear clearfix"></div>
            <a class="button button-primary affiliate-btn" target="_blank" href="https://premio.io/affiliates/?utm_source=inapp&plugin=mystickyelements&domain=<?php echo esc_url(site_url("/")) ?>">Tell me more <span class="dashicons dashicons-arrow-right-alt"></span></a>
        </div>
...
$MyStickyElements_affiliate_program = new MyStickyElements_affiliate_program();
