...
<div id="mystickyelements-tab-live-chatway" class="mystickyelements-tab-live-chatway mystickyelements-options" style="display: <?php echo ( isset($widget_tab_index) && $widget_tab_index == 'mystickyelements-live-chatway' ) ? 'block' : 'none'; ?>;">
	...
	<div class="myStickyelements-header-title myStickyelements-chatway-header">
		<h3> <strong><?php esc_html_e('Step 4:','mystickyelements'); ?></strong>  <?php esc_html_e('Add live chat','mystickyelements'); ?></h3> 
	</div>
	...
	<div class="myStickyelements-chatway-content">
		...
		<div class="myStickyelements-chatway-right">
			...
			<?php else : ?>
				<div class="mystickyelements-header-sub-title">
					<h4><?php esc_html_e('Connect effortlessly with customers through Live Chat!', 'mystickyelements');?></h4>
				</div>
				<p>
			...
			<div class="mystickyelement-tab-boxes-btn-wrap">
				...
				<?php endif;?> 
				<span class="small-text"><strong><?php esc_html_e('Skip', 'mystickyelements'); ?></strong> <?php esc_html_e('this step by saving the widget','mystickyelements');?></span>
			</div>
		</div> 
	</div>
</div>