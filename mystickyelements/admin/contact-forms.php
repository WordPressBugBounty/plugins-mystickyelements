...
$contact_form['phone_formate'] 			= isset($contact_form['phone_formate']) ? $contact_form['phone_formate'] : '';
$contact_form['dropdown-placeholder'] 	= isset($contact_form['dropdown-placeholder']) ? $contact_form['dropdown-placeholder'] : '';
$contact_form['name'] 					= isset($contact_form['name']) ? $contact_form['name'] : '';
$contact_form['phone'] 					= isset($contact_form['phone']) ? $contact_form['phone'] : '';
$contact_form['email'] 					= isset($contact_form['email']) ? $contact_form['email'] : '';
$contact_form['message'] 				= isset($contact_form['message']) ? $contact_form['message'] : '';
$contact_form['phone_require'] 			= isset($contact_form['phone_require']) ? $contact_form['phone_require'] : '';
$contact_form['email_require'] 			= isset($contact_form['email_require']) ? $contact_form['email_require'] : '';
$contact_form['phone_number_length'] 	= isset($contact_form['phone_number_length']) ? $contact_form['phone_number_length'] : '';
$contact_form['enable'] 				= isset($contact_form['enable']) ? $contact_form['enable'] : '';

$contact_form['name_value'] 			= isset($contact_form['name_value']) ? $contact_form['name_value'] : '';
$contact_form['phone_value'] 			= isset($contact_form['phone_value']) ? $contact_form['phone_value'] : '';
									...
									<div class="sticky-col-2">
										...
										<div class="mystickyelements-action">
											<ul>
												...
												<li>
													<label for="dropdown_require"><?php esc_html_e('Required', 'mystickyelements');?></label>
			...
			<div class="myStickyelements-content-section mystickyelements-display-main-options">
				...
				<div class="mystickyelements-display-above-options myStickyelements-contact-form-tab">
					<div class="myStickyelements-header-title">
						<h3><?php esc_html_e('Contact Tab Settings', 'mystickyelements'); ?></h3>
					</div>
					<div class="myStickyelements-setting-wrap-list-main">
						...
						<div class="myStickyelements-setting-wrap myStickyelements-setting-wrap-list ><!--myStickyelements-setting-half-->">
							...
							<div class="mystickyelements-setting-wrap-right">
								<input type="text" id="tab_background_color" name="contact-form[tab_background_color]" class="mystickyelement-color" value="<?php echo esc_attr($contact_form['tab_background_color']);?>" />
							</div>
						</div>
						<div class="myStickyelements-setting-wrap myStickyelements-setting-wrap-list">
							<div class="mystickyelements-setting-wrap-left">
							...
							<div class="mystickyelements-setting-wrap-right">
								<input type="text" id="tab_text_color" name="contact-form[tab_text_color]" class="mystickyelement-color" value="<?php echo esc_attr($contact_form['tab_text_color']);?>" />
							</div>
						</div>
						<div class="myStickyelements-setting-wrap myStickyelements-setting-wrap-list">
							<div class="mystickyelements-setting-wrap-left">
						...
						<div class="myStickyelements-setting-wrap myStickyelements-setting-wrap-list">
							...
							<div class="mystickyelements-setting-wrap-right">
								<input type="text" id="headine_text_color" name="contact-form[headine_text_color]" class="mystickyelement-color" value="<?php echo esc_attr($contact_form['headine_text_color']);?>" />
							</div>
						</div>
				...
				<div class='contact-form-popup-label'>
					...
					<div class="contact-form-field-select-wrap mystickyelements-free-version">
						<label class="contact-form-field-select">
							...
							<span><i class="far fas fa-edit"></i><?php esc_html_e('Text', 'mystickyelements'); ?></span>
						</label>
						<label class="contact-form-field-select">
							<input type="radio" name="radio_btn" />
							<span><i class="fas fa-align-justify"></i><?php esc_html_e('Text Area', 'mystickyelements'); ?> </span>
						</label>
						<label class="contact-form-field-select">
							<input type="radio" name="radio_btn" />
							<span><i class="fas fa-phone"></i><?php esc_html_e('Number', 'mystickyelements'); ?> </span>
						</label>
						<label class="contact-form-field-select">
							<input type="radio" name="radio_btn" />
							<span><i class="fas fa-calendar-week"></i><?php esc_html_e('Date', 'mystickyelements'); ?></span>
						</label>
						<label class="contact-form-field-select">
							<input type="radio" name="radio_btn" />
							<span><i class="fas fa-link"></i><?php esc_html_e('Website', 'mystickyelements'); ?></span>
						</label>
						<label class="contact-form-field-select">
							<input type="radio" name="radio_btn" />
							<span><i class="fas fa-caret-down"></i><?php esc_html_e('Dropdown', 'mystickyelements'); ?></span>
						</label>
						<label class="contact-form-field-select">
							<input type="radio" name="radio_btn" />
						...
						<label class="contact-form-field-select">
							<input type="radio" name="radio_btn" />
							<span><i class="fas fa-tools"></i><?php esc_html_e('IP Log', 'mystickyelements'); ?></span>
						</label>
						<label class="contact-form-field-select">
							<input type="radio" name="radio_btn" />
							<span><i class="fas fa-tools"></i><?php esc_html_e('reCAPTCHA', 'mystickyelements'); ?></span>
						</label>
						<label class="contact-form-field-select">
							<input type="radio" name="radio_btn" />
							<span><i class="far far fa-newspaper"></i><?php esc_html_e('Text Block', 'mystickyelements'); ?></span>
						</label>
			...
			<div class="contact-form-dropdown-open contact-form-setting-popup-open" style="display: none;">
				<div class="contact-form-dropdown-main">
					...
					<input type="submit" name="submit" class="button button-primary btn-save-dropdown"
							value="<?php esc_html_e('Save', 'mystickyelements'); ?>">
				</div>
				<span class="contact-form-dropdfown-close"><i class="fas fa-times"></i></span>
			</div>
